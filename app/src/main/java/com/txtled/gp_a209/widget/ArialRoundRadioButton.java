...
public class ArialRoundRadioButton extends RadioButton {
    public ArialRoundRadioButton(@NonNull Context context) {
        super(context);
        init(context,null,0);
    }

    public ArialRoundRadioButton(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context,attrs,0);
    }

    public ArialRoundRadioButton(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
