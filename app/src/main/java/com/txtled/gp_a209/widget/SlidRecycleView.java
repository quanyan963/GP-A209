 ...
 */
public class SlidRecycleView extends RecyclerView {
    ...
    public SlidRecycleView(@NonNull Context context) {
        this(context,null,0);
    }

    public SlidRecycleView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public SlidRecycleView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (mPosition != INVALID_POSITION) {
                    ...
                    if (mFlingView.getChildCount() == 4) {
                        mMenuViewWidth = mFlingView.getChildAt(2).getWidth();
                    } else {
